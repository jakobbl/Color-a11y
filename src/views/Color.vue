  ...
  >
    ...
    <div class="Color-options">
      <input
        ...
        v-model="hsluv"
        id="hsluv-option"
        class="Color-optionCheckbox"
      />
      <span v-if="hsluv">√ </span>
      <span v-else>X </span>
      <label for="hsluv-option" class="Color-optionLabel">HSLuv</label>
      <a href="#" class="Color-changeMode">Open in crossgrid</a>
    </div>
